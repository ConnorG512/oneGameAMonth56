...
Game::Projectile::Projectile(std::pair<int, int> screen_max_xy, std::pair<float, float> xy,
                             std::pair<float, float> vel_xy, LuaInstance &lua, SDL_Renderer &renderer)
    : screen_max_xy_{screen_max_xy}, bounds_{xy.first,
                                             xy.second,
